...
import "./login.css";
import { getUser, signUpCC } from "../../../redux/actions/userActions";
...
class CustomerCareLogin extends React.Component {
  constructor() {
    super();
    this.state = {
      email: "",
  ...
  handlesubmit = event => {
    ...
    this.props.signUpCC(data, history);
  };
            ...
            <div className="col-md-6 ">
              <div className="card  mb-3 shadow login-card">
                <div className="card-body text-dark ">
                  ...
                  <Link to="/care/login">Already, have an account, login</Link>
                </div>
              </div>
            </div>
...
export default connect(mapStateToProps, mapActionsToProps)(CustomerCareLogin);
