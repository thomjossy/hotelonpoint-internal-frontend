...
import "./login.css";
import { getUser, signUpAdmin } from "../../../redux/actions/userActions";
...
class AdminSignUp extends React.Component {
  ...
  handlesubmit = event => {
    ...
    this.props.signUpAdmin(data, history);
  };
...
export default connect(mapStateToProps, mapActionsToProps)(AdminSignUp);
