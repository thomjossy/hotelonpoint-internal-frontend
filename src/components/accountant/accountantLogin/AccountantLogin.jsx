...
import "./login.css";
import { getUser, loginAccountant } from "../../../redux/actions/userActions";
...
class AccountantLogin extends React.Component {
  ...
  handlesubmit = event => {
    ...
    this.props.loginAccountant(data, history);
  };
...
export default connect(mapStateToProps, mapActionsToProps)(AccountantLogin);
